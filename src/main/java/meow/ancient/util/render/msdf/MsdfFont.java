package meow.ancient.util.render.msdf;

import net.minecraft.client.render.VertexConsumer;
import net.minecraft.text.Text;
import org.joml.Matrix4f;
import meow.ancient.util.parse.ParseTextUtil;
import meow.ancient.util.render.font.Font;
import meow.ancient.util.render.font.FontData;
import meow.ancient.util.render.font.MsdfGlyph;
