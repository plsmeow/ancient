...
import meow.ancient.util.render.renderers.impl.BuiltTexture;
...
public final class GpsRenderer implements IMinecraft {
    ...
    private GpsRenderer() { Ancient.getInstance().getEventBus().subscribe(this); }
