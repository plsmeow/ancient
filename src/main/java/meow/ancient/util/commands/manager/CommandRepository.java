package meow.ancient.util.commands.manager;
...
import meow.ancient.util.commands.api.exception.CommandUnhandledException;
import meow.ancient.util.commands.api.exception.ICommandException;
...
import meow.ancient.util.commands.defaults.DefaultCommands;
    ...
    public Stream<String> tabComplete(String prefix) {
        ...
        if (args.isEmpty()) {
            return new TabCompleteHelper()
                    .addCommands(Ancient.getInstance().getCommandRepository())
                    .filterPrefix(label)
                    .stream();
        } else {
