...
public class HelpCommand extends Command {
    Ancient ancient;
    protected HelpCommand(Ancient ancient) {
        super("help");
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        CommandRepository commandRepository = ancient.getCommandRepository();
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "С помощью этой команды можно просмотреть подробную справочную информацию о том, как использовать определенные команды Ancient.",
                "",
                "Использование:",
