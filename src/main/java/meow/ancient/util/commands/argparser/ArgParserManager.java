...
package meow.ancient.util.commands.argparser;

import meow.ancient.util.commands.api.argparser.IArgParser;
...
import meow.ancient.util.commands.api.exception.CommandNoParserForTypeException;
