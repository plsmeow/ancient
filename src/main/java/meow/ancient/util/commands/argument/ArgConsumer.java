...
package meow.ancient.util.commands.argument;
...
import meow.ancient.util.commands.api.datatypes.IDatatype;
import meow.ancient.util.commands.api.datatypes.IDatatypeContext;
import meow.ancient.util.commands.api.datatypes.IDatatypeFor;
import meow.ancient.util.commands.api.datatypes.IDatatypePost;
import meow.ancient.util.commands.api.exception.CommandException;
import meow.ancient.util.commands.api.exception.CommandInvalidTypeException;
import meow.ancient.util.commands.api.exception.CommandNotEnoughArgumentsException;
import meow.ancient.util.commands.api.exception.CommandTooManyArgumentsException;
