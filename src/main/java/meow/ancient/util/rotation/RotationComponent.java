package meow.ancient.util.rotation;
...
import meow.ancient.event.list.EventPlayerSyncEnd;
...
public class RotationComponent extends Component {
    public static RotationComponent getInstance() {
        return meow.ancient.util.base.Instance.getComponent(RotationComponent.class);
    }
