...
import meow.ancient.module.list.combat.rotations.test2.ApproachController;
import meow.ancient.module.list.combat.rotations.test2.HumanizedRotationController;
import meow.ancient.module.list.combat.rotations.test2.RotationNoise;
import meow.ancient.module.list.combat.rotations.test2.RotationState;
import meow.ancient.module.list.combat.rotations.test2.TargetPointSelector;
import meow.ancient.module.list.combat.rotations.test2.VerticalCorrectionController;
 ...
 * {@link meow.ancient.module.list.combat.rotations.test2}.
 */
