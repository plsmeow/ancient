...
import meow.ancient.module.settings.*;
import meow.ancient.ui.component.Component;
import meow.ancient.ui.component.impl.*;
        ...
        if (animation.getValue() > 0.01f) {
            ...
            for (Component component : components) {
                ...
                if (component.isVisible() || visibleProgress > 0) {
                    ...
                    meow.ancient.util.render.math.Scissor.push();
                    meow.ancient.util.render.math.Scissor.setFromComponentCoordinates(x, intersectY, width, intersectHeight);

                    component.render(matrixStack, mouseX, mouseY, partialTicks);

                    meow.ancient.util.render.math.Scissor.unset();
                    meow.ancient.util.render.math.Scissor.pop();
