...
/**
 * Delta-styled multi-mode chips widget ported from DeltaClient
 * (aethereal.ui.element.MultiModeElement): toggleable chips for ModeListSetting.
 */
public class DeltaModeListElement extends DeltaElement<ModeListSetting> {
    private final DeltaAnimation[] modeAnimations;

    public DeltaModeListElement(ModeListSetting setting) {
        super(setting);
        this.modeAnimations = new DeltaAnimation[setting.getSettings().size()];
    ...
    public boolean onMouseClick(double mouseX, double mouseY, int button) {
        ...
        for (var booleanSetting : this.setting.getSettings()) {
            String mode = booleanSetting.getName();
    ...
    public void render(DrawContext context, double mouseX, double mouseY, float delta, float extend) {
        ...
        for (var booleanSetting : this.setting.getSettings()) {
            ...
            this.modeAnimations[i].tick(booleanSetting.getValue());
