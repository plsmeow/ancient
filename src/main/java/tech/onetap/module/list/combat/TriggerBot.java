...
public class TriggerBot extends Module {
    ...
    public boolean canCritical() {
        ...
        boolean groundSpoofActive = Onetap.getInstance().getModuleStorage().get(GroundSpoof.class).isEnabled()
                && Onetap.getInstance().getModuleStorage().get(GroundSpoof.class).mode.is("False");
